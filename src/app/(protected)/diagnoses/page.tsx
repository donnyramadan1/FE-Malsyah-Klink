...
export default function DiagnosesPage() {
  ...
  const [selectedDiagnosis, setSelectedDiagnosis] =
    useState<DiagnosisDto | null>(null);
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">Kelola data diagnosa pasien</p>
          </div>
          <motion.button
        ...
        <DiagnosisTable
          diagnoses={diagnoses}
          loading={loading}
          onEdit={(diagnosis: SetStateAction<DiagnosisDto | null>) => {
        ...
        <DiagnosisModal
          ...
          onSave={async (data: CreateDiagnosisDto) => {
            if (selectedDiagnosis) {
              await updateDiagnosis(
                selectedDiagnosis.id,
                data as UpdateDiagnosisDto
              );
            } else {
              await createDiagnosis(data as CreateDiagnosisDto);
            }
            setOpen(false);
          }}
        />
