...
type FormData = CreateDiagnosisDto | UpdateDiagnosisDto;
...
export default function DiagnosisForm({ diagnosis, onSubmit, onClose }: Props) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
            Nama Diagnosa <span className="text-red-500">*</span>
          </label>
          <input
            type="text"
            name="name"
            ...
            placeholder="Misal: Hipertensi Stage 1"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
            onChange={handleChange}
            placeholder="Deskripsi klinis diagnosa"
          />
        </div>
        ...
        <div className="flex justify-end gap-3 pt-6">
          ...
          >
            ...
            {isEdit ? "Simpan Perubahan" : "Tambah Diagnosa"}
          </button>
        </div>
      </form>
    </motion.div>
